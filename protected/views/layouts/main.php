...
<!--    <![endif]-->
    ...
    <link rel="stylesheet" type="text/css" href="
    <?php echo Yii::app()->request->baseUrl; ?>/css/font-awesome.css" />
...
//                        array('label' => 'Generaror', 'url' => array('/form/create')),
                        ...
                        array('label' => Yii::t('app', 'Feedback') , 'url' => array('/feedback/index'), 'visible'=>!Yii::app()->user->isGuest),
    ...
    <script type="text/javascript">
        (function (d, w, c) {
            (w[c] = w[c] || []).push(function() {
                try {
                    w.yaCounter43544534 = new Ya.Metrika({
                        id:43544534,
                        clickmap:true,
                        trackLinks:true,
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/43544534" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
